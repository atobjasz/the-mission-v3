...
export default function ReactorMinigame({ onComplete, onAbort }: Props) {
  ...
  return (
    <div className="space-y-2 sm:space-y-3 flex flex-col h-full">
      ...
      <div className="grid grid-cols-3 grid-rows-3 gap-2 sm:gap-3 h-[240px] sm:h-[300px] lg:flex-1 lg:h-auto lg:min-h-0">
        {Array.from({ length: NUM_TILES }, (_, i) => {
          ...
          return (
            <button
              ...
              disabled={!canPress}
              className={`
                relative w-full h-full rounded-xl font-display font-bold text-xl sm:text-2xl lg:text-3xl
